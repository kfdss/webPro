...
<html>
	...
	<head>
		...
		<title>易机网|手机回收,二手机回收,二手手机交易,手机回收网,旧手机回收|手机回收专业平台</title>
		...
		<script src="hom/js/jquery-1.7.2.min.js" type="text/javascript"></script>
		<script src="hom/js/common.js" type="text/javascript"></script>
		<link rel="stylesheet" href="base-all.css" tppabs="http://www.58yiji.com/resources/v2/css/base-all.css">
		<link rel="stylesheet" href="index.css" tppabs="http://www.58yiji.com/resources/v2/css/index.css">
	...
	<body>
			...
			<div class="global_topbar banner-recylce">
				<div class="nav-column">
					<div class="nav-left">
						...
						<div class="globar_topbar_links">
							<a href="index.html" tppabs="http://www.58yiji.com/index.html"><span>旧机回收</span><i class="line">下划线</i></a>
					...
					<div class="nav-right">
						<ul>
							...
							<li class="search-r">
								<a href="index.html" tppabs="http://www.58yiji.com/index.html"><i class="search-navbr">搜索</i></a><i class="line-bar">线</i>
								<!-- 
                        <div class="nav-select nav-select-sh">
                         ...
                         -->
							...
							<li class="phone-s">
								...
								<div class="nav-select">
									<i class="select-tringle"></i>
									<a href="javascript:;" class="last-child erweima"><img src="code_03.jpg" alt="" width="130" height="130">
										<p>易机网移动端</p>
									</a>
								</div>
							</li>
				...
				<div class="main-search">
					...
					<div class="advantages">
						<span class="high-price"><img src="2.png" alt="">高价回收</span>
						<span><img src="3.png" alt="">隐私保护</span>
						<span><img src="4.png" alt="">专业质检</span>
						<span><img src="5.png" alt="">极速打款</span>
						<span class="keep-safe"><img src="6.png" alt="">价保无忧</span>
					</div>
					...
					<a href="#proQuility" class="tringle-infinite"><img src="7.png" alt=""></a>
				</div>
				<script type="text/javascript">
					jQuery(function() {
						//获得焦点事件
					...
					function ajaxQueryDate() {
						...
						$.ajax({
							type: 'post',
							url: "ajaxByKeyWord.html.js" /*tpa=http://www.58yiji.com/ajaxByKeyWord.html*/ ,
							data: {
								"keyWord": keyWord
							},
							dataType: 'json',
		...
		<div class="step-recycle">
			<div class="container">
				...
				<div class="step1"><img src="8.png" alt="">
					<p>搜索估价机型</p>
				</div><i class="tringle-r"><img src="9.png" alt=""></i>
				<div class="step1"><img src="10.png" alt="">
					<p>评估回收价</p>
				</div><i class="tringle-r"><img src="9.png" alt=""></i>
				<div class="step1"><img src="11.png" alt="">
					<p>提交订单并发货</p>
				</div><i class="tringle-r"><img src="9.png" alt=""></i>
				<div class="step1"><img src="12.png" alt="">
					<p>坐等收钱</p>
				</div>
								...
								<ul>
									<li class="active" title="苹果">
										<a href="javascript:;">
											...
											<img src="a919cac6-3f3f-4433-9c25-4f1d097fdb89.png" class="hover-black">
										</a>
									</li>
									<li title="三星">
										<a href="javascript:;">
											...
											<img src="7c77647f-4217-485c-b859-033fee4d3dc7.png" class="hover-black">
										</a>
									</li>
									<li title="小米">
										<a href="javascript:;">
											...
											<img src="4f52eb8c-a0f4-4dd5-8501-15a6068bd2be.png" class="hover-black">
										</a>
									</li>
									<li title="魅族">
										<a href="javascript:;">
											...
											<img src="6cc166e9-9833-4deb-8a53-94aaa70afef6.png" class="hover-black">
										</a>
									</li>
									<li title="华为">
										<a href="javascript:;">
											...
											<img src="688d4512-d98a-41b9-9a9b-6e22d9003fe1.png" class="hover-black">
										</a>
									</li>
									<li title="HTC">
										<a href="javascript:;">
											...
											<img src="c88232ed-8943-41c2-a42a-4114325f6af0.png" class="hover-black">
										</a>
									</li>
									<li title="金立">
										<a href="javascript:;">
											...
											<img src="d1c2e728-558b-4c0c-b0dc-2d46d68c85f4.png" class="hover-black">
										</a>
									</li>
									<li title="诺基亚">
										<a href="javascript:;">
											...
											<img src="14eb640f-2942-49bb-b2e6-476b7b7f0da2.png" class="hover-black">
										</a>
									</li>
									<li title="黑莓">
										<a href="javascript:;">
											...
											<img src="44e2a942-06f8-4322-ab11-0fe472d2ede9.png" class="hover-black">
										</a>
									</li>
									<li title="索尼">
										<a href="javascript:;">
											...
											<img src="69b426d8-7216-4f24-a4af-fab3533d9407.png" class="hover-black">
										</a>
									</li>
									<li title="联想">
										<a href="javascript:;">
											...
											<img src="a3ed9683-9c14-4721-abff-844a2d503af4.png" class="hover-black">
										</a>
									</li>
									<li title="摩托罗拉">
										<a href="javascript:;">
											...
											<img src="1ea40050-6af4-4492-8a4d-f6cdde134da0.png" class="hover-black">
										</a>
									</li>
									<li title="酷派">
										<a href="javascript:;">
											...
											<img src="183aa7a0-896e-4a65-90d3-62884e382f2b.png" class="hover-black">
										</a>
									</li>
									<li>
									...
									<li title="OPPO">
										<a href="javascript:;">
											...
											<img src="836ef88c-f63b-4219-b4cf-c3b273ad058e.png" class="hover-black">
										</a>
									</li>
									<li title="LG">
										<a href="javascript:;">
											...
											<img src="8bcf6bb1-770b-40c4-9ea1-ed4edc62d6f0.png" title="LG" class="hover-black">
										</a>
									</li>
									<li title="天语">
										<a href="javascript:;">
											...
											<img src="1df2621a-8964-4398-ab03-f7520d5239a9.png" title="天语" class="hover-black">
										</a>
									</li>
									<li title="中兴">
										<a href="javascript:;">
											...
											<img src="de49338c-e006-46b3-b11f-f242bf7ccc45.png" title="中兴" class="hover-black">
										</a>
									</li>
									<li title="TCL">
										<a href="javascript:;">
											...
											<img src="78e81f22-312d-4af9-acf8-54ec008d757c.png" title="TCL" class="hover-black">
										</a>
									</li>
									<li title="vivo">
										<a href="javascript:;">
											...
											<img src="bd29e57a-c1fc-44c9-90e7-64b3aae851e5.png" title="vivo" class="hover-black">
										</a>
									</li>
									<li title="朵唯">
										<a href="javascript:;">
											...
											<img src="462c8cb3-84c9-4577-9c19-7ec6cc11fc64.png" title="朵唯" class="hover-black">
										</a>
									</li>
									<li title="Nubia">
										<a href="javascript:;">
											...
											<img src="8a72a100-2500-4714-ab5d-cd72898210f3.png" title="Nubia" class="hover-black">
										</a>
									</li>
									<li title="微软">
										<a href="javascript:;">
											...
											<img src="1996d2f3-ad9b-46ac-89ca-d872b35e1d58.png" title="微软" class="hover-black">
										</a>
									</li>
									<li title="华硕">
										<a href="javascript:;">
											...
											<img src="2bb63a00-71f2-41e3-afc6-97018c2a943e.png" title="华硕" class="hover-black">
										</a>
									</li>
									<li title="谷歌">
										<a href="javascript:;">
											...
											<img src="826e50c3-5859-4ee9-9a30-2b3b0a549e59.png" title="谷歌" class="hover-black">
										</a>
									</li>
									<li title="乐视">
										<a href="javascript:;">
											...
											<img src="ea5a86d2-95b7-437e-a546-944b96f0156b.png" title="乐视" class="hover-black">
										</a>
									</li>
									<li title="vertu">
										<a href="javascript:;">
											...
											<img src="82f747d7-1f44-4df1-8df3-993cf4617bcb.png" title="vertu" class="hover-black">
										</a>
									</li>
									<li title="ZUK">
										<a href="javascript:;">
											...
											<img src="494e2e9c-1173-401e-8164-e30eb3b57b90.png" title="ZUK" class="hover-black">
										</a>
									</li>
									<li title="小辣椒">
										<a href="javascript:;">
											...
											<img src="7d6e9cd8-0387-47c8-86af-56317317c160.png" title="小辣椒" class="hover-black">
										</a>
									</li>
									<li title="青橙">
										<a href="javascript:;">
											...
											<img src="3d4e7f8e-7ec2-4265-a63b-b69df93a0731.png" title="青橙" class="hover-black">
										</a>
									</li>
									<li title="奇酷">
										<a href="javascript:;">
											...
											<img src="ddb15669-d04a-4a83-bd23-3cbd8c9f0801.png" title="奇酷" class="hover-black">
										</a>
									</li>
									<li title="飞利浦">
										<a href="javascript:;">
											...
											<img src="06402923-f523-4484-bd33-7c9c8715fe2f.png" title="飞利浦" class="hover-black">
										</a>
									</li>
									<li title="YOTAPHONE">
										<a href="javascript:;">
											...
											<img src="6d8b55f1-70a8-439c-9f1d-c3fac51f1e7f.png" title="YOTAPHONE" class="hover-black">
										</a>
									</li>
									<li title="环保机型">
										<a href="javascript:;">
											...
											<img src="cf581e4f-efbd-48c0-967d-097adb2f1e17.png" title="环保机型" class="hover-black">
										</a>
									</li>
									<li title="亚马逊">
										<a href="javascript:;">
											...
											<img src="8665267e-1222-4725-b029-9034ebf78758.png" title="亚马逊" class="hover-black">
										</a>
									</li>
									<li title="詹姆士">
										<a href="javascript:;">
											...
											<img src="002293b3-649b-43c7-beea-a1b2d4455348.png" title="詹姆士" class="hover-black">
										</a>
									</li>
									<li title="酷比">
										<a href="javascript:;">
											...
											<img src="83b92450-2c74-400c-977d-21903de2ab81.png" title="酷比" class="hover-black">
										</a>
									</li>
									<li title="VETAS">
										<a href="javascript:;">
											...
											<img src="88adcf89-395f-4a3c-b8a7-440a4bd79bec.png" title="VETAS" class="hover-black">
										</a>
									</li>
									<li title="8848">
										<a href="javascript:;">
											...
											<img src="58f0c4c7-c951-4ef1-8560-65685cae7419.png" title="8848" class="hover-black">
										</a>
									</li>
									<li title="一加">
										<a href="javascript:;">
											...
											<img src="1e0a99c6-f369-4795-bd50-5895227dffad.png" title="一加" class="hover-black">
										</a>
									</li>
									<li title="美图">
										<a href="javascript:;">
											...
											<img src="2562c062-10a8-442f-9c9c-690ddff5aa21.png" title="美图" class="hover-black">
										</a>
									</li>
									<li title="锤子">
										<a href="javascript:;">
											...
											<img src="649f47dc-427e-4a54-ac37-6b05b5289ab3.png" title="锤子" class="hover-black">
										</a>
									</li>
								</ul>
							</div>
								...
								<ul>
									...
									<li title="LG">
										<a href="javascript:;">
											...
											<input type="hidden" value="15">
											<input type="hidden" value="LG">
											<img src="8bcf6bb1-770b-40c4-9ea1-ed4edc62d6f0.png" class="hover-black">
										</a>
									</li>
									<li title="微软">
										<a href="javascript:;">
											...
											<input type="hidden" value="29">
											<input type="hidden" value="微软">
											<img src="1996d2f3-ad9b-46ac-89ca-d872b35e1d58.png" class="hover-black">
										</a>
									</li>
									<li title="华硕">
										<a href="javascript:;">
											...
											<input type="hidden" value="30">
											<input type="hidden" value="华硕">
											<img src="2bb63a00-71f2-41e3-afc6-97018c2a943e.png" class="hover-black">
										</a>
									</li>
									<li>
										<a href="javascript:;" class="show-more"><span>展开更多</span> <i></i></a>
									...
									<li title="谷歌">
										<a href="javascript:;">
											...
											<input type="hidden" value="31">
											<input type="hidden" value="谷歌">
											<img src="826e50c3-5859-4ee9-9a30-2b3b0a549e59.png" class="hover-black">
										</a>
									</li>
									<li title="飞利浦">
										<a href="javascript:;">
											...
											<input type="hidden" value="39">
											<input type="hidden" value="飞利浦">
											<img src="06402923-f523-4484-bd33-7c9c8715fe2f.png" class="hover-black">
										</a>
									</li>
									<li title="E人E本">
										<a href="javascript:;">
											...
											<img src="5660f48d-50ad-4418-8693-0c2972753165.png" class="hover-black">
										</a>
									</li>
									<li title="惠普">
										<a href="javascript:;">
											...
											<img src="b6a67f4d-5ace-4343-ba5c-32d1600bf84b.png" class="hover-black">
										</a>
									</li>
									<li title="VOYO">
										<a href="javascript:;">
											...
											<img src="a2de032c-101f-4fb0-b43f-9b13ccf824ea.png" class="hover-black">
										</a>
									</li>
									<li title="亚马逊">
										<a href="javascript:;">
											...
											<input type="hidden" value="45">
											<input type="hidden" value="亚马逊">
											<img src="8665267e-1222-4725-b029-9034ebf78758.png" class="hover-black">
										</a>
									</li>
									<li title="戴尔">
										<a href="javascript:;">
											...
											<img src="8d6a1649-eaa2-4e71-8dfe-bfafc4180dd7.png" class="hover-black">
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="pro-list">
							...
							<ul id="productUl">
								<li title="苹果 iPhone 8">
									<a href="3041.html" tppabs="http://www.58yiji.com/wymj/3041.html">
										<div class="pro-img"><img src="97bca775-5327-4156-8c92-a79e1b6e643f.png"></div>
										<h2 class="pro-name">苹果 iPhone 8</h2>
										<p class="pro-num">目前已回收20台</p>
									</a>
								</li>
								<li title="苹果iPhone 6s">
									<a href="1591.html" tppabs="http://www.58yiji.com/wymj/1591.html">
										<div class="pro-img"><img src="9475200a-e977-4b66-aa77-1b5538369b52.png"></div>
										<h2 class="pro-name">苹果iPhone 6s</h2>
										<p class="pro-num">目前已回收9864台</p>
									</a>
								</li>
								<li title="苹果 iPhone 6">
									<a href="1167.html" tppabs="http://www.58yiji.com/wymj/1167.html">
										<div class="pro-img"><img src="140bfd81-c0e4-4268-bfc7-10b092b70d98.png"></div>
										<h2 class="pro-name">苹果 iPhone 6</h2>
										<p class="pro-num">目前已回收17035台</p>
									</a>
								</li>
								<li title="苹果iPhone X">
									<a href="3043.html" tppabs="http://www.58yiji.com/wymj/3043.html">
										<div class="pro-img"><img src="df06d715-83e7-48ae-bd07-5445d75206f6.png"></div>
										<h2 class="pro-name">苹果iPhone X</h2>
										<p class="pro-num">目前已回收46台</p>
									</a>
								</li>
								<li title="苹果 iPhone 7 Plus">
									<a href="2135.html" tppabs="http://www.58yiji.com/wymj/2135.html">
										<div class="pro-img"><img src="37808028-366c-4566-8afe-67e4e3c4b298.png"></div>
										<h2 class="pro-name">苹果 iPhone 7 Plus</h2>
										<p class="pro-num">目前已回收846台</p>
									</a>
								</li>
								<li title="苹果 iPhone 7">
									<a href="2134.html" tppabs="http://www.58yiji.com/wymj/2134.html">
										<div class="pro-img"><img src="d673093d-02c9-41bc-b710-b093d9bc4e9d.png"></div>
										<h2 class="pro-name">苹果 iPhone 7</h2>
										<p class="pro-num">目前已回收965台</p>
									</a>
								</li>
								<li title="苹果 iPhone 7 Plus（A1784）">
									<a href="2983.html" tppabs="http://www.58yiji.com/wymj/2983.html">
										<div class="pro-img"><img src="8f907726-65d7-4a76-8ca7-b53cf4647874.png"></div>
										<h2 class="pro-name">苹果 iPhone 7 Plus（A1784）</h2>
										<p class="pro-num">目前已回收0台</p>
									</a>
								</li>
								<li title="苹果 iPhone 7（A1778）">
									<a href="2982.html" tppabs="http://www.58yiji.com/wymj/2982.html">
										<div class="pro-img"><img src="0901507b-0869-4667-b56f-5167fa5d6b16.png"></div>
										<h2 class="pro-name">苹果 iPhone 7（A1778）</h2>
										<p class="pro-num">目前已回收11台</p>
									</a>
								</li>
								<li title="苹果iPhone 6S Plus">
									<a href="1590.html" tppabs="http://www.58yiji.com/wymj/1590.html">
										<div class="pro-img"><img src="6e23f524-76b7-4866-88d9-edaf8f4c234e.png"></div>
										<h2 class="pro-name">苹果iPhone 6S Plus</h2>
										<p class="pro-num">目前已回收5551台</p>
									</a>
								</li>
								<li title="苹果 iPhone 6 Plus">
									<a href="1165.html" tppabs="http://www.58yiji.com/wymj/1165.html">
										<div class="pro-img"><img src="c80f5b21-872b-4c37-8a7a-88af13e250ae.png"></div>
										<h2 class="pro-name">苹果 iPhone 6 Plus</h2>
										<p class="pro-num">目前已回收9640台</p>
									</a>
								</li>
								<li title="苹果 iphone 8 plus">
									<a href="3042.html" tppabs="http://www.58yiji.com/wymj/3042.html">
										<div class="pro-img"><img src="df06d715-83e7-48ae-bd07-5445d75206f6.png"></div>
								...
								<li title="苹果 iPhone 5">
									<a href="3.html" tppabs="http://www.58yiji.com/wymj/3.html">
										<div class="pro-img"><img src="7eab09b1-706e-45e4-bbb8-1bd6eed3be93.png"></div>
										<h2 class="pro-name">苹果 iPhone 5</h2>
										<p class="pro-num">目前已回收4030台</p>
									</a>
								</li>
								<li title="苹果 iPhone 5C">
									<a href="4.html" tppabs="http://www.58yiji.com/wymj/4.html">
										<div class="pro-img"><img src="add3b05b-1608-40bf-8612-dd35ec4e15ef.png"></div>
										<h2 class="pro-name">苹果 iPhone 5C</h2>
										<p class="pro-num">目前已回收597台</p>
									</a>
								</li>
								<li title="苹果 iPhone 4s">
									<a href="2.html" tppabs="http://www.58yiji.com/wymj/2.html">
										<div class="pro-img"><img src="e1538f72-340a-439a-b0bb-d57894ab6194.png"></div>
										<h2 class="pro-name">苹果 iPhone 4s</h2>
										<p class="pro-num">目前已回收5401台</p>
									</a>
								</li>
								<li title="苹果 iPhone 4（A1332）">
									<a href="1.html" tppabs="http://www.58yiji.com/wymj/1.html">
										<div class="pro-img"><img src="e48e8a3c-8299-4291-ae54-7e29f062eef2.png"></div>
		...
		<div class="pro-quility">
			<div class="container">
				<div class="left">
					<video id="my-video" class="video-js " controls width="565p;" height="330px;" poster="/resources/v2/images/user-comt.jpg" data-setup="{}">
		...
		<div class="part-two">
		    <div class="container">
		        ...
		        <ul>
		        	<li>
				                <a href="javascript:;">
				                    <div class="user-img"><img src="http://imgspace.yjshou.com/resources/userUpLoadImages/320_320/" alt="" width="362px" height="195px"></div>
				                    <p class="user-name"></p>
		...
		<div class="footer">
			<div class="container">
				<ul>
					...
					<li class="five">
						...
						<p class="ewm"><img src="erweima.png" alt="" height="90" width="90"></p>
					</li>
					<!-- 
            <li class="five">
                <p class="name-ewm">关注公众号查订单</p>
                <p class="ewm"><img src="/resources/v2/images/erweima.png" alt="" height="90" width="90"></p>
            </li>
             -->
				</ul>
			</div>
			...
			<div style="width:300px;margin:0 auto; padding:20px 0;">
				<a target="_blank" href="javascript:if(confirm(%27http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44030502001885  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44030502001885%27" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="record.png" style="float:left;" />
					<p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px; color:#939393;">粤公网安备 44030502001885号</p>
				</a>
			</div>
		</div>
		<script type="text/javascript" src="video.js" tppabs="http://www.58yiji.com/resources/v2/js/video.js"></script>
		<script type="text/javascript">
		...
		<div class="nav-right-bar">
			<a href="javascript:;" class="info-kf"><img src="r-bar1.png" alt=""></a>
			<a href="javascript:;" class="attention-us"><img src="r-bar2.png" alt="">
				<div class="erweima">
					<p>扫码关注</p>
					<img src="erweima.png" alt="" width="100" height="100">
				</div>
			</a>
			<a href="javascript:;" class="go-top"><img src="r-bar3.png" alt=""></a>
		</div>
		<!--资讯客服弹出框-->
				...
				<div class="cart_con">
					...
					<div class="cart_Box">
						<div class="cart_box" style="display: block;">
							<div class="cartdiv">
								<p><img class="no_lazy" src="Qcart.jpg" alt="在线客服"></p>
								<a target="_blank" href="javascript:if(confirm(%27http://wpa.qq.com/msgrd?v=3&uin=3266325200&site=qq&menu=yes  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://wpa.qq.com/msgrd?v=3&uin=3266325200&site=qq&menu=yes%27" tppabs="http://wpa.qq.com/msgrd?v=3&uin=3266325200&site=qq&menu=yes">旧机回收</a>
								<a target="_blank" href="javascript:if(confirm(%27http://wpa.qq.com/msgrd?v=3&uin=3266325200&site=qq&menu=yes  \n\nThis file was not retrieved by Teleport Pro, because it is addressed on a domain or path outside the boundaries set for its Starting Address.  \n\nDo you want to open it from the server?%27))window.location=%27http://wpa.qq.com/msgrd?v=3&uin=3266325200&site=qq&menu=yes%27" tppabs="http://wpa.qq.com/msgrd?v=3&uin=3266325200&site=qq&menu=yes">二手良品</a>
							</div>
						</div>
					...
					<div class="cart_bottom">
						<dl>
							<dt><img class="no_lazy" src="mezi.png" alt="联系客服"></dt>
							<dd>
