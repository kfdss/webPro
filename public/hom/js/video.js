...
var Player = function (_Component) {
  ...
  Player.prototype.loadTech_ = function loadTech_(techName, source) {
    ...
    var techOptions = (0, _obj.assign)({
      ...
      'vtt.js'/*tpa=http://www.58yiji.com/resources/v2/js/vtt.js*/: this.options_['vtt.js'/*tpa=http://www.58yiji.com/resources/v2/js/vtt.js*/]
...
var Tech = function (_Component) {
  ...
  Tech.prototype.addWebVttScript_ = function addWebVttScript_() {
    ...
    if (_document2['default'].body.contains(this.el())) {
      ...
      if (!this.options_['vtt.js'/*tpa=http://www.58yiji.com/resources/v2/js/vtt.js*/] && (0, _obj.isPlain)(vtt) && Object.keys(vtt).length > 0) {
      ...
      script.src = this.options_['vtt.js'/*tpa=http://www.58yiji.com/resources/v2/js/vtt.js*/] || 'https://vjs.zencdn.net/vttjs/0.12.3/vtt.min.js';
...
var selectConfigs = {
  ...
  fontPercent: {
    ...
    label: 'Font Size',
    options: [['http://www.58yiji.com/resources/v2/js/0.50', '50%'], ['http://www.58yiji.com/resources/v2/js/0.75', '75%'], ['http://www.58yiji.com/resources/v2/js/1.00', '100%'], ['http://www.58yiji.com/resources/v2/js/1.25', '125%'], ['http://www.58yiji.com/resources/v2/js/1.50', '150%'], ['http://www.58yiji.com/resources/v2/js/1.75', '175%'], ['http://www.58yiji.com/resources/v2/js/2.00', '200%'], ['http://www.58yiji.com/resources/v2/js/3.00', '300%'], ['http://www.58yiji.com/resources/v2/js/4.00', '400%']],
    'default': 2,
    parser: function parser(v) {
      return v === 'http://www.58yiji.com/resources/v2/js/1.00' ? null : Number(v);
    }
  },
 ...
 *
 * @param {string} path
 *        The fileName path like 'http://www.58yiji.com/path/to/file.mp4'
 *
 * @returns {string}
